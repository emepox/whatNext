  ...
  return (
    <div style={{ width: "100%", height: "100%", background: "#ffff" }}>
      <Parallax ref={parallax} pages={3}>
        <ParallaxLayer offset={1} speed={1} factor={1} style={{ backgroundColor: "#DCE0EB" }}/>
        <ParallaxLayer offset={2} speed={1} factor={3} style={{ backgroundColor: "#1C2530" }}/>
        ...
        <ParallaxLayer offset={2.4} speed={-0.3} style={{display: "flex", alignItems: "center", justifyContent: "center", pointerEvents: "none"}}>
