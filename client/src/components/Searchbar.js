      ...
      {isProfile && (
        <div className="flex flex-col justify-center items-center">
          ...
          <div className="flex border-b border-gray-200">
            <button
              onClick={() => requestData()}
              className="fontAwesome flex items-center h-10 px-2 py-2 -mb-px text-center text-gray-700 bg-transparent border-b-2 border-transparent sm:px-4 -px-1 whitespace-nowrap focus:outline-none hover:border-gray-400 focus:border-purple-500 focus:text-purple-500"
            >
              <span>&#xf15c;</span>
            ...
            <button
              ...
              className="fontAwesome flex items-center h-10 px-2 py-2 -mb-px text-center text-gray-700 bg-transparent border-b-2 border-transparent sm:px-4 -px-1 whitespace-nowrap cursor-base focus:outline-none hover:border-gray-400 focus:border-purple-500 focus:text-purple-500"
            >
              <span>&#xf004;</span>
